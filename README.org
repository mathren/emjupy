...
- [ ] latex rendering in =markdown= cells (optional, if needed with dependencies)
- [ ] cleanup commands
- [ ] use font highlight and colors to distinguish kernels, notebooks
  and other things in =emjupy-notebook-list=, group and sort with
  notebooks at top
