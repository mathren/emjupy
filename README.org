...
#+Assisted-by: various LLMs (Claude Sonnet, Opus, Gemini, chatGPT)
...
=emjupy= is a multi-file Emacs package (see the Emacs Lisp manual,
"Multi-file Packages"). Build a tar and install it:
