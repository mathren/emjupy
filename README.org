...
- [ ] upon reshowing output, the background color is removed (for output/warnings/errors/figures)
- [ ] first and last line numbers of cell is at the outline using
  ...
  line of output instead? Adding
- [ ] Turn huge Reame.org into documentation in separate folder/file.
  Add badge for docs, organize in UI, design, intercommunication,
  logical sections
