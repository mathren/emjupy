...
- [ ] scrambling issue on re-drawing still present, can corrupt
  notebooks. This needs fixing: corrupting notebooks is never ok.
- [ ] =C-c C-k= always jump at end of notebook, should move point to nearest cell below.
