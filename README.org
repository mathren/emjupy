...
- [ ] add =emjupy-export-py= to export to plain python file (save the shadow buffer to a file). should prompt for location starting from the folder of the notebook (possibly remote)
