...
- [ ] execution of cells/output arriving, etc should not jigger the view
- [ ] why is parentesis autocompletion not active in emjupy? Should I
  configure the relative package?
** Hold
