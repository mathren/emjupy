...
- [ ] =undo= scrambles everything if undoing something in another cell:
  rendering issue? :rendering:
- [ ] fix highlighting/background :rendering:
  - [ ] syntax highlighting is at cell execution, not while typing
  - [ ] wrong background color
- [ ] implement view similar to the buffer =*ein:notebooklist <address>= :feature:
- [ ] Makefile: emacs now says =package-buffer-info: Package lacks a
  file header= :bug:
