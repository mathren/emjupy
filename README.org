...
- [ ] =tqdm= does not draw progress bar anymore (but shows timer)
- [ ]  =emjupy-interrupt-kernel= gives =emjupy--http-request: JSON Parse Error on /api/kernels/1ecbe90c-7ac9-4be7-9bf4-2ab5c260886f/interrupt: (json-end-of-file 1 0 0)=, fix
