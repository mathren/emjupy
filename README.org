...
| =C-c C-o=       | hide or show this cell's output             |
...
The binding is =C-c C-o= rather than =C-c h=: keys of the form
=C-c <letter>= are reserved for users, and a package may not take them.
